...
// End Cross Module References
	DEFINE_FUNCTION(UEstapeToolsBPLibrary::execSafeStringToFloat)
	{
		P_GET_PROPERTY(FStrProperty,Z_Param_StringValue);
		P_GET_PROPERTY_REF(FFloatProperty,Z_Param_Out_FloatValue);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(bool*)Z_Param__Result=UEstapeToolsBPLibrary::SafeStringToFloat(Z_Param_StringValue,Z_Param_Out_FloatValue);
		P_NATIVE_END;
	}
	...
	void UEstapeToolsBPLibrary::StaticRegisterNativesUEstapeToolsBPLibrary()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "SafeStringToFloat", &UEstapeToolsBPLibrary::execSafeStringToFloat },
		};
	...
	struct Z_Construct_UFunction_UEstapeToolsBPLibrary_SafeStringToFloat_Statics
	{
		struct EstapeToolsBPLibrary_eventSafeStringToFloat_Parms
		{
			FString StringValue;
			float FloatValue;
			bool ReturnValue;
	...
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UEstapeToolsBPLibrary_SafeStringToFloat_Statics::NewProp_StringValue = { "StringValue", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(EstapeToolsBPLibrary_eventSafeStringToFloat_Parms, StringValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UEstapeToolsBPLibrary_SafeStringToFloat_Statics::NewProp_FloatValue = { "FloatValue", nullptr, (EPropertyFlags)0x0010000000000180, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(EstapeToolsBPLibrary_eventSafeStringToFloat_Parms, FloatValue), METADATA_PARAMS(nullptr, 0) };
	void Z_Construct_UFunction_UEstapeToolsBPLibrary_SafeStringToFloat_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
		((EstapeToolsBPLibrary_eventSafeStringToFloat_Parms*)Obj)->ReturnValue = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UEstapeToolsBPLibrary_SafeStringToFloat_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(EstapeToolsBPLibrary_eventSafeStringToFloat_Parms), &Z_Construct_UFunction_UEstapeToolsBPLibrary_SafeStringToFloat_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UEstapeToolsBPLibrary_SafeStringToFloat_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UEstapeToolsBPLibrary_SafeStringToFloat_Statics::NewProp_StringValue,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UEstapeToolsBPLibrary_SafeStringToFloat_Statics::NewProp_FloatValue,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UEstapeToolsBPLibrary_SafeStringToFloat_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UEstapeToolsBPLibrary_SafeStringToFloat_Statics::Function_MetaDataParams[] = {
		{ "Category", "EstapeTools|Utilities|Convertions" },
		{ "CompactNodeTitle", "SafeToFloat" },
		{ "Keywords", "Safe, Convert, Float, String" },
		{ "ModuleRelativePath", "Public/EstapeToolsBPLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UEstapeToolsBPLibrary_SafeStringToFloat_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UEstapeToolsBPLibrary, nullptr, "SafeStringToFloat", nullptr, nullptr, sizeof(EstapeToolsBPLibrary_eventSafeStringToFloat_Parms), Z_Construct_UFunction_UEstapeToolsBPLibrary_SafeStringToFloat_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UEstapeToolsBPLibrary_SafeStringToFloat_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14422401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UEstapeToolsBPLibrary_SafeStringToFloat_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UEstapeToolsBPLibrary_SafeStringToFloat_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UEstapeToolsBPLibrary_SafeStringToFloat()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UEstapeToolsBPLibrary_SafeStringToFloat_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UEstapeToolsBPLibrary_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UEstapeToolsBPLibrary_SafeStringToFloat, "SafeStringToFloat" }, // 3331415375
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UEstapeToolsBPLibrary, 812089880);
