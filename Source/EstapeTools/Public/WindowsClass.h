...
class ESTAPETOOLS_API UWindowsClass : public UBlueprintFunctionLibrary
{
    ...
    UFUNCTION(BlueprintPure, Category = "EstapeTools|Utilities|Windows|Battery", meta = (Keywords = "Battery Windows"))
    ...
    UFUNCTION(BlueprintPure, Category = "EstapeTools|Utilities|Windows", meta = (Keywords = "Windows info"))
