...
FProcessHandle UEstapeToolsBPLibrary::CreateProcessSync(const FString ProgramFolder, const FString Parameters)
{
    ...
    SyncProcess = FPlatformProcess::ExecProcess(TCHAR_ProgramFolder, TCHAR_Parameters, &ReturnCode, &StrOut, &StrErr, nullptr);
